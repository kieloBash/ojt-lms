...
const IntroComponent = () => {
  return (
    <>
      {/* MOBILE */}
      <Card className="flex flex-col p-4 xl:hidden lg:hidden md:hidden">
        <h2 className="text-2xl font-semibold text-left">{`Let's Get Started!`}</h2>
        ...
        <div className="relative w-full mt-4 overflow-hidden rounded-md">
          <CldVideoPlayer
            id="sea-turtle"
            width={"1920"}
            height={"1080"}
        ...
        <div className="flex flex-col mt-2">
          ...
          <ul className="flex flex-col gap-1 mt-2 ml-4 text-xs list-decimal">
            <li className="">
      ...
      {/* DESKTOP */}
      <Card className="flex-col hidden p-4 xl:flex lg:flex md:flex">
        ...
        <div className="grid w-full grid-cols-5 gap-8 mt-6">
          ...
          <div className="flex flex-col col-span-3">
            ...
            <ul className="flex flex-col gap-1 mt-2 ml-4 list-decimal">
              <li className="">
                Go to the <span className="font-medium">{`"Calendar"`}</span>{" "}
                tab located on the left side.
              </li>
              <li className="">{`There will be notifications in case you haven't enrolled for a class that week.`}</li>
              <li className="">
                From there you can click the{" "}
                <span className="font-medium">{`"Add Class"`}</span> button on
