...
import { DiscoverYR } from "@/utils/helpers/stripe/prices";
import { Book, CrownIcon, Loader2Icon } from "lucide-react";
import Link from "next/link";

const DiscoverYRButton = ({
  p,
  userInfo,
}: {
  userInfo: any;
...
export default DiscoverYRButton;
